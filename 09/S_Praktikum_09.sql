...
-- Für SQL-Server (umschalten von master auf die zu nutzende DB):
USE DB_Praktikum_09;
...
CREATE TABLE Lieblingsbier (
  ...
  CONSTRAINT FK_Besucher_LB     FOREIGN KEY (Bname, Bvorname) REFERENCES Besucher(Name, Vorname),
...
CREATE TABLE Sortiment (
  ...
  CONSTRAINT FK_Restaurant_S	FOREIGN KEY (Rname) REFERENCES Restaurant(Name),
